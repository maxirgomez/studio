...
import { ArrowLeft, MapPin, Scan, Ruler, Building, FileText, User, Home, Mailbox, Phone, Smartphone, Mail, Info, XCircle, Scaling, Percent, CreditCard, DollarSign } from "lucide-react"

// Mock data (ideally, fetch this based on SMP)
const listings = [
  { address: "Av. Santa Fe 1060", neighborhood: "Palermo", smp: "017-027-020A", area: 110, origen: "Tor", codigoUrbanistico: "U.S.A.M.", cpu: "R2b1", partida: "123456-7" },
  { address: "Juramento 1196", neighborhood: "Belgrano", smp: "017-059-048D", area: 162, origen: "Baigun Realty", codigoUrbanistico: "C.M.", cpu: "R1a", partida: "234567-8" },
  { address: "Rivadavia 1298", neighborhood: "Caballito", smp: "017-027-006", area: 185, origen: "Producción", codigoUrbanistico: "U.S.A.A.", cpu: "C3II", partida: "345678-9" },
  { address: "Corrientes 1341", neighborhood: "Almagro", smp: "031-036-034", area: 174, origen: "Tor", codigoUrbanistico: "C.M.", cpu: "C1", partida: "456789-0" },
  { address: "Scalabrini Ortiz 1494", neighborhood: "Recoleta", smp: "017-026-022", area: 210, origen: "Baigun Realty", codigoUrbanistico: "A.E.", cpu: "R1b", partida: "567890-1" },
  { address: "Quintana 1577", neighborhood: "San Telmo", smp: "031-053-037", area: 150, origen: "Producción", codigoUrbanistico: "A.P.H.", cpu: "APH1", partida: "678901-2" },
  { address: "Defensa 1684", neighborhood: "Villa Crespo", smp: "031-055-029", area: 195, origen: "Tor", codigoUrbanistico: "U.S.A.B.2", cpu: "R2bII", partida: "789012-3" },
  { address: "Login Exitoso", neighborhood: "Bienvenido, Admin!", smp: "031-114-032", area: 95, origen: "Baigun Realty", codigoUrbanistico: "C.M.", cpu: "C3I", partida: "890123-4" },
  { address: "Another Listing 1", neighborhood: "Palermo", smp: "017-027-021A", area: 120, origen: "Producción", codigoUrbanistico: "U.S.A.M.", cpu: "R2b1", partida: "901234-5" },
  { address: "Another Listing 2", neighborhood: "Belgrano", smp: "017-059-049D", area: 170, origen: "Tor", codigoUrbanistico: "C.M.", cpu: "R1a", partida: "012345-6" },
];
